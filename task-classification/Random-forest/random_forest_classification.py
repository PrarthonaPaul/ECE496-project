...
splits = {
    ...
    "val_iron": "data/val_iron-00000-of-00001.parquet",
    "val_neg": "data/val_neg-00000-of-00001.parquet",
}
df_train = pd.read_parquet(
    "hf://datasets/jakeazcona/short-text-labeled-emotion-classification/"
    + splits["train"]
)
...
print(
    "Classification reports saved to training_classification_report.txt and test_classification_report.txt"
)
